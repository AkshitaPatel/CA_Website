  ...
  return (
    <div className="disclaimer rounded-lg z-0">
      ...
      <p>
        ...
        manner. By accessing this website, www.dsa.com, you acknowledge and
        confirm that you are seeking information relating to DSA & Co LLP on
        your own accord and that there has been no form of solicitation,
        advertisement or inducement by DSA & Co LLP or its partners or
        employees.
        <br />
        ...
        professional advice. DSA & Co LLP shall not be liable for consequences
        of any action taken by relying on the information provided on this
        website. It is recommended that the readers should take professional
        advice before acting on the same. The contents of this website are the
        intellectual property of DSA & Co LLP.
